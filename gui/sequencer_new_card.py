...
class Ui_create_card_dialog(object):
    def setupUi(self, create_card_dialog):
        ...
        create_card_dialog.resize(468, 480)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.line_name = QtWidgets.QLineEdit(parent=create_card_dialog)
        ...
        self.btn_save = QtWidgets.QPushButton(parent=create_card_dialog)
        self.btn_save.setGeometry(QtCore.QRect(140, 430, 93, 28))
        self.btn_save.setObjectName("btn_save")
        self.btn_exit = QtWidgets.QPushButton(parent=create_card_dialog)
        self.btn_exit.setGeometry(QtCore.QRect(240, 430, 93, 28))
    ...
    def retranslateUi(self, create_card_dialog):
        ...
        self.btn_save.setText(_translate("create_card_dialog", "Сохранить"))
        self.btn_exit.setText(_translate("create_card_dialog", "Отмена"))
